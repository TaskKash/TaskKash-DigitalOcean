  ...
  wallet: router({
    ...
    requestWithdrawal: publicProcedure
      .input(z.object({
        userId: z.number(),
        amount: z.number(),
        method: z.enum(['vodafone_cash', 'instapay', 'fawry', 'bank_transfer']),
