      ...
      .mutation(async ({ input }) => {
        ...
        await db.execute(sql`
          INSERT INTO tasks (advertiserId, type, titleEn, titleAr, descriptionEn, descriptionAr,
            reward, totalBudget, maxCompletions as completionsNeeded, minimumBudget, status, duration,
          ...
          VALUES (${input.advertiserId}, ${input.type}, ${input.titleEn}, ${input.titleAr || ''},
            ...
            ${input.totalBudget}, ${input.maxCompletions}, ${input.totalBudget}, 'draft', 5,
        ...
        return {
          ...
          summary: {
            ...
            completionRate: task.maxCompletions > 0
              ? ((stats.totalCompletions / task.maxCompletions) * 100).toFixed(1) : 0,
          },
        };
      }),
