...
CREATE TABLE `badges` (
  ...
  `category` enum('tasks','earnings','referrals','streaks','special') COLLATE utf8mb4_unicode_ci DEFAULT 'tasks',
  `requirement` json DEFAULT NULL,
  `rewardAmount` decimal(10,2) DEFAULT '0.00',
  `rarity` enum('common','rare','epic','legendary') COLLATE utf8mb4_unicode_ci DEFAULT 'common',
  `createdAt` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
CREATE TABLE `referrals` (
  ...
  `status` enum('pending','completed','rewarded') COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
...
CREATE TABLE `user_levels` (
  ...
  `badgeIcon` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2025-11-11 19:19:05
